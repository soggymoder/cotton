...
int 
cottonwindow_init (CottonWindow *cw, const char *title, int window_w, int window_h, int texture_w, int texture_h)
{
...
void 
cottonwindow_update(CottonWindow *cw, const void *buffer, int pitch)
{
